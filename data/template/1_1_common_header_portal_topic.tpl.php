...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1440355708, '1', './data/template/1_1_common_header_portal_topic.tpl.php', './template/default', 'common/header_portal_topic')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1440355708, '1', './data/template/1_1_common_header_portal_topic.tpl.php', './template/default', 'common/header_portal_topic')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1440355708, '1', './data/template/1_1_common_header_portal_topic.tpl.php', './template/default', 'common/header_portal_topic')
;?>
