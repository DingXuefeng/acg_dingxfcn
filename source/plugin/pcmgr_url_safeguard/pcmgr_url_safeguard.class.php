...
class plugin_pcmgr_url_safeguard{
	function _include_js(){
		...
		$jsscript = '<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.4.4/jquery.min.js" type="text/javascript"></script>';
		...
		#$jsscript .= '<link rel="stylesheet" type="text/css" href="https://s.pc.qq.com/discuz/css/style.css" />';
		$jsscript .= '<link rel="stylesheet" type="text/css" href="/static/css/s.pc.qq.com~discuz~css~style.css" />';
		return $jsscript;
	}
}
